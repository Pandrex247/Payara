...
public class ThreadPoolStatsImpl
    ...
    private void initializeStats() throws NoSuchWorkQueueException {
        ...
        currentNumberOfThreads =
                ...
                threadPool.currentNumberOfThreads(), threadPool.maximumNumberOfThreads(), threadPool.minimumNumberOfThreads(), Long.MAX_VALUE, 0,
        ...
        averageWorkCompletionTime =
                new BoundedRangeStatisticImpl(
                threadPool.averageWorkCompletionTime(), 0, 0, Long.MAX_VALUE, 0,
        ...
        numberOfWorkItemsInQueue =
                new BoundedRangeStatisticImpl(
                workQueue.workItemsInQueue(), 0, 0, Long.MAX_VALUE, 0,
        ...
        averageTimeInQueue =
                new BoundedRangeStatisticImpl(
                workQueue.averageTimeInQueue(), 0, 0, Long.MAX_VALUE, 0,
