...
public class InstanceStats implements InstanceStatsInterface, CommonBean {
	...
	public void setApplicationStats(boolean[] value) {
		...
		for (int i = 0; i < value.length; ++i) {
			_ApplicationStats.add((value[i] ? Boolean.TRUE : Boolean.FALSE));
		}
	}

	public void setApplicationStats(int index, boolean value) {
		_ApplicationStats.set(index, (value ? Boolean.TRUE : Boolean.FALSE));
	}

	public boolean[] getApplicationStats() {
		boolean[] arr = new boolean[_ApplicationStats.size()];
		for (int i = 0; i < arr.length; ++i) {
			arr[i] = ((Boolean)_ApplicationStats.get(i)).booleanValue();
		}
		return arr;
	}
	...
	public boolean isApplicationStats(int index) {
		return ((Boolean)_ApplicationStats.get(index)).booleanValue();
	}
	...
	public int addApplicationStats(boolean value) {
		_ApplicationStats.add((value ? Boolean.TRUE : Boolean.FALSE));
		return _ApplicationStats.size()-1;
	}

	// Search from the end looking for @param value, and then remove it.
	public int removeApplicationStats(boolean value) {
		int pos = _ApplicationStats.indexOf((value ? Boolean.TRUE : Boolean.FALSE));
		if (pos >= 0) {
	...
	public void writeNode(java.io.Writer out, String nodeName, String indent) throws java.io.IOException {
		...
		if (_Id != null) {
			out.write(" id");	// NOI18N
			out.write("='");	// NOI18N
			LoadBalancerStats.writeXML(out, _Id, true);
			out.write("'");	// NOI18N
		}
		...
		if (_Health != null) {
			...
			out.write("='");	// NOI18N
			LoadBalancerStats.writeXML(out, _Health, true);
			out.write("'");	// NOI18N
		}
		...
		if (_NumTotalRequests != null) {
			...
			out.write("='");	// NOI18N
			LoadBalancerStats.writeXML(out, _NumTotalRequests, true);
			out.write("'");	// NOI18N
		}
		...
		if (_NumActiveRequests != null) {
			...
			out.write("='");	// NOI18N
			LoadBalancerStats.writeXML(out, _NumActiveRequests, true);
			out.write("'");	// NOI18N
		}
		out.write(">\n");
		...
		for (java.util.Iterator it = _ApplicationStats.iterator(); 
			it.hasNext(); ) {
			boolean element = ((Boolean)it.next()).booleanValue();
			if (element) {
				...
				if (_ApplicationStatsId != null) {
					out.write(" id");	// NOI18N
					out.write("='");	// NOI18N
					LoadBalancerStats.writeXML(out, _ApplicationStatsId, true);
					out.write("'");	// NOI18N
				}
				...
				if (_ApplicationStatsAverageResponseTime != null) {
					...
					out.write("='");	// NOI18N
					LoadBalancerStats.writeXML(out, _ApplicationStatsAverageResponseTime, true);
					out.write("'");	// NOI18N
				}
				...
				if (_ApplicationStatsMinResponseTime != null) {
					...
					out.write("='");	// NOI18N
					LoadBalancerStats.writeXML(out, _ApplicationStatsMinResponseTime, true);
					out.write("'");	// NOI18N
				}
				...
				if (_ApplicationStatsMaxResponseTime != null) {
					...
					out.write("='");	// NOI18N
					LoadBalancerStats.writeXML(out, _ApplicationStatsMaxResponseTime, true);
					out.write("'");	// NOI18N
				}
				...
				if (_ApplicationStatsNumFailoverRequests != null) {
					...
					out.write("='");	// NOI18N
					LoadBalancerStats.writeXML(out, _ApplicationStatsNumFailoverRequests, true);
					out.write("'");	// NOI18N
				}
				...
				if (_ApplicationStatsNumErrorRequests != null) {
					...
					out.write("='");	// NOI18N
					LoadBalancerStats.writeXML(out, _ApplicationStatsNumErrorRequests, true);
					out.write("'");	// NOI18N
				}
				// num-active-requests is an attribute
				if (_ApplicationStatsNumActiveRequests != null) {
					out.write(" num-active-requests");	// NOI18N
					out.write("='");	// NOI18N
					LoadBalancerStats.writeXML(out, _ApplicationStatsNumActiveRequests, true);
					out.write("'");	// NOI18N
				}
				...
				if (_ApplicationStatsNumIdempotentUrlRequests != null) {
					...
					out.write("='");	// NOI18N
					LoadBalancerStats.writeXML(out, _ApplicationStatsNumIdempotentUrlRequests, true);
					out.write("'");	// NOI18N
				}
				// num-total-requests is an attribute
				if (_ApplicationStatsNumTotalRequests != null) {
					out.write(" num-total-requests");	// NOI18N
					out.write("='");	// NOI18N
					LoadBalancerStats.writeXML(out, _ApplicationStatsNumTotalRequests, true);
					out.write("'");	// NOI18N
				}
				out.write("/>\n");	// NOI18N
			}
		...
		for (int i = 0, size = children.getLength(); i < size; ++i) {
			...
			if (childNodeName == "application-stats") {
				...
				if (childNode.getFirstChild() == null)
					...
					aApplicationStats = Boolean.valueOf(childNodeValue).booleanValue();
				...
				_ApplicationStats.add((aApplicationStats ? Boolean.TRUE : Boolean.FALSE));
				lastElementType = 4;
			}
			else {
	...
	public void validate() throws LoadBalancerStats.ValidateException {
		...
		if (getId() == null) {
			throw new LoadBalancerStats.ValidateException("getId() == null", "id", this);	// NOI18N
		}
		// Validating property health
		if (getHealth() == null) {
			throw new LoadBalancerStats.ValidateException("getHealth() == null", "health", this);	// NOI18N
		}
		// Validating property numTotalRequests
		if (getNumTotalRequests() == null) {
			throw new LoadBalancerStats.ValidateException("getNumTotalRequests() == null", "numTotalRequests", this);	// NOI18N
		}
		// Validating property numActiveRequests
		if (getNumActiveRequests() == null) {
			throw new LoadBalancerStats.ValidateException("getNumActiveRequests() == null", "numActiveRequests", this);	// NOI18N
		}
		// Validating property applicationStatsId
		if (getApplicationStatsId() == null) {
			throw new LoadBalancerStats.ValidateException("getApplicationStatsId() == null", "applicationStatsId", this);	// NOI18N
		}
		// Validating property applicationStatsAverageResponseTime
		if (getApplicationStatsAverageResponseTime() == null) {
			throw new LoadBalancerStats.ValidateException("getApplicationStatsAverageResponseTime() == null", "applicationStatsAverageResponseTime", this);	// NOI18N
		}
		// Validating property applicationStatsMinResponseTime
		if (getApplicationStatsMinResponseTime() == null) {
			throw new LoadBalancerStats.ValidateException("getApplicationStatsMinResponseTime() == null", "applicationStatsMinResponseTime", this);	// NOI18N
		}
		// Validating property applicationStatsMaxResponseTime
		if (getApplicationStatsMaxResponseTime() == null) {
			throw new LoadBalancerStats.ValidateException("getApplicationStatsMaxResponseTime() == null", "applicationStatsMaxResponseTime", this);	// NOI18N
		}
		// Validating property applicationStatsNumFailoverRequests
		if (getApplicationStatsNumFailoverRequests() == null) {
			throw new LoadBalancerStats.ValidateException("getApplicationStatsNumFailoverRequests() == null", "applicationStatsNumFailoverRequests", this);	// NOI18N
		}
		// Validating property applicationStatsNumErrorRequests
		if (getApplicationStatsNumErrorRequests() == null) {
			throw new LoadBalancerStats.ValidateException("getApplicationStatsNumErrorRequests() == null", "applicationStatsNumErrorRequests", this);	// NOI18N
		}
		// Validating property applicationStatsNumActiveRequests
		if (getApplicationStatsNumActiveRequests() == null) {
			throw new LoadBalancerStats.ValidateException("getApplicationStatsNumActiveRequests() == null", "applicationStatsNumActiveRequests", this);	// NOI18N
		}
		// Validating property applicationStatsNumIdempotentUrlRequests
		if (getApplicationStatsNumIdempotentUrlRequests() == null) {
			throw new LoadBalancerStats.ValidateException("getApplicationStatsNumIdempotentUrlRequests() == null", "applicationStatsNumIdempotentUrlRequests", this);	// NOI18N
		}
		// Validating property applicationStatsNumTotalRequests
		if (getApplicationStatsNumTotalRequests() == null) {
			throw new LoadBalancerStats.ValidateException("getApplicationStatsNumTotalRequests() == null", "applicationStatsNumTotalRequests", this);	// NOI18N
		}
	}
	...
	public void changePropertyByName(final String nameIn, Object value) {
		...
		if (name == "id")
			...
			setNumTotalRequests((String)value);
		else if (name == "numActiveRequests")
			setNumActiveRequests((String)value);
		else if (name == "applicationStats")
			addApplicationStats(((Boolean)value).booleanValue());
		else if (name == "applicationStats[]")
			setApplicationStats((boolean[]) value);
		else if (name == "applicationStatsId")
			setApplicationStatsId((String)value);
		else if (name == "applicationStatsAverageResponseTime")
			setApplicationStatsAverageResponseTime((String)value);
		else if (name == "applicationStatsMinResponseTime")
			setApplicationStatsMinResponseTime((String)value);
		else if (name == "applicationStatsMaxResponseTime")
			setApplicationStatsMaxResponseTime((String)value);
		else if (name == "applicationStatsNumFailoverRequests")
			setApplicationStatsNumFailoverRequests((String)value);
		else if (name == "applicationStatsNumErrorRequests")
			setApplicationStatsNumErrorRequests((String)value);
		else if (name == "applicationStatsNumActiveRequests")
			setApplicationStatsNumActiveRequests((String)value);
		else if (name == "applicationStatsNumIdempotentUrlRequests")
			setApplicationStatsNumIdempotentUrlRequests((String)value);
		else if (name == "applicationStatsNumTotalRequests")
			setApplicationStatsNumTotalRequests((String)value);
		else
	...
	public boolean equals(Object o) {
		...
		for (java.util.Iterator it = _ApplicationStats.iterator(), it2 = inst._ApplicationStats.iterator(); 
			...
			boolean element = ((Boolean)it.next()).booleanValue();
			boolean element2 = ((Boolean)it2.next()).booleanValue();
			if (!(element == element2))
				return false;
		}
