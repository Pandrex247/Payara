...
public class ResourceHandlers {
    ...
    @Handler(id="gf.getConfigPropsInfo",
    	input={
        @HandlerInput(name="extraProps", type= Map.class),
    ...
    */
    @Handler(id="gf.combineProperties",
    	input={
        @HandlerInput(name="tableList", type= List.class)},
        output={
        @HandlerOutput(name="combined", type= List.class)})
    ...
    @Handler(id="gf.buildConfidentialPropsTable",
        ...
        @HandlerInput(name="confidentialList", type= List.class)},
        output={
        @HandlerOutput(name="result", type= List.class),
        @HandlerOutput(name="hasConfidentialProps", type=Boolean.class) })
    ...
    @Handler(id="gf.getLogicalJndiName",
            input={
                    ...
                    @HandlerInput(name="listRow", type= List.class)},
            output={
                    @HandlerOutput(name="result", type= List.class) })
