 ...
 * would instantiate an implementation of {@link Outbound}. (The
 ...
 * {@link Inbound}. (The {@link org.glassfish.admin.payload.PayloadImpl.Inbound}
 * is such an implementation.
 * <p>
 * Payload.Inbound exposes the {@link Inbound#parts()} method
...
public interface Payload {
    ...
    public static interface Outbound {
         ...
         * include the directory and its contents use {@link #attachFile(String, URI, String, File, boolean) }
