...
public class WriteableView implements InvocationHandler, Transactor, ConfigView {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        Property property = bean.model.toProperty(method);
    ...
    public synchronized Object getter(Property property, Type t) {
    ...
    public synchronized void setter(Property property,
                                    Object newValue, Type t)  {
    ...
    public Property getProperty(String xmlName) {
    ...
    public synchronized List<PropertyChangeEvent> commit(Transaction t) throws TransactionFailure {
        ...
        try {
            ...
            for (PropertyChangeEvent event : changedAttributes.values()) {
                Property property = bean.model.findIgnoreCase(event.getPropertyName());
...
private class ProtectedList<E> extends AbstractList<E> {
    ...
    private void handleValidation(Property property, Object value)
