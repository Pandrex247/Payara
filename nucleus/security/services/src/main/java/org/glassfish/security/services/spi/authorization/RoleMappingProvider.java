 ...
 * <code>{@link RoleMappingService}</code>
...
public interface RoleMappingProvider extends SecurityProvider {
	 ...
	 *
	 * @see {@link RoleMappingService#isUserInRole(String, AzSubject, AzResource, String)}
	 */
	 ...
	 * 
	 * @see {@link RoleMappingService#findOrCreateDeploymentContext(String)}
	 */
