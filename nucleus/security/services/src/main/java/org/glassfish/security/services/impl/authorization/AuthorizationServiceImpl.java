 ...
 * <code>{@link AuthorizationService}</code>
...
public final class AuthorizationServiceImpl implements AuthorizationService, PostConstruct {
    ...
    private final List<AzAttributeResolver> attributeResolvers =
            Collections.synchronizedList(new ArrayList<AzAttributeResolver>());
     ...
     * @see AuthorizationService#isPermissionGranted(Subject, Permission)
     */
    @Override
     ...
     * @see AuthorizationService#isAuthorized(Subject, URI)
     */
    @Override
     ...
     * @throws IllegalArgumentException Given null or illegal subject or resource
     * @throws IllegalStateException Service was not initialized.
     * @see AuthorizationService#isAuthorized(Subject, URI, String)
     */
    @Override
     ...
     * @see AuthorizationService#makeAzSubject(Subject)
     */
    @Override
     ...
     * @see AuthorizationService#makeAzResource(URI)
     ...
     *
     * @see PostConstruct#postConstruct()
     */
    @Override
